...
// Sapper.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSapperApp, CWinApp)
...
// Единственный объект CSapperApp

CSapperApp theApp;


// Инициализация CSapperApp

BOOL CSapperApp::InitInstance()
{
